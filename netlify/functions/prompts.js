...
const MINIMAL_FILLER = {
  lips: {
    conservative: 'a natural but clearly visible lip enhancement: more body through both lips, improved vermilion show, and a slightly more defined vermilion border, so the lips read fuller and well hydrated while staying restrained. The change should be noticeable in a side-by-side comparison, never subtle to the point of looking untreated',
    moderate: 'a clearly noticeable, natural lip enhancement: build the body of both lips with improved vermilion show, gentle anterior projection, and a more defined vermilion border and Cupid\'s bow, so the lips read visibly fuller, hydrated, and well supported. The change should read plainly as tasteful lip filler',
    enhanced: 'a substantial, clearly visible lip enhancement equivalent to about 2 cc of HA filler, as an experienced injector would place it: noticeably build the body of both the upper and lower lip with strong vermilion show, clear anterior projection, a well-defined central tubercle, and a crisp, well-supported vermilion border, so the lips read distinctly fuller, hydrated, and structurally supported. The result must be plainly and immediately obvious in a side-by-side comparison and read as a confident, tasteful lip filler result, while keeping natural upper-to-lower proportion and the same mouth width, never overfilled, everted, or duck-shaped'
  },
  chin: {
  ...
  nose: {
    conservative: 'a subtle non-surgical nose refinement (liquid rhinoplasty): a slightly straighter, smoother side profile and a little more bridge height, with the tip left largely as it is. Keep a natural bridge appropriate for this face, do not narrow the nose, and do not create a high, narrow, or European-style nose',
    moderate: 'a visible non-surgical nose refinement (liquid rhinoplasty): a straighter, smoother side profile, a higher but natural bridge with better radix-to-tip continuity, and slightly improved tip projection and support. Keep the result soft and appropriate for this face, do not narrow the nose, and do not create a high, narrow, surgical, or European-style nose',
    enhanced: 'a clearly noticeable non-surgical nose refinement (liquid rhinoplasty) as an experienced injector would place it: a distinctly straighter, smoother side profile, a higher but natural bridge with a smooth continuous line from between the brows down to the tip, and improved tip projection and support, while staying believable for HA filler and never surgical. Keep the nose width from the front unchanged, keep the result soft and appropriate for this face, and do not narrow the nose or create a high, narrow, surgical, or European-style nose'
  },
  nasolabial_folds: {
