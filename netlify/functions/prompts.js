...
const BIOSTIM_NEGATIVE_GUARDRAIL =
  ' CRITICAL ANTI-BEAUTIFICATION GUARDRAIL: Do not beautify, de-age, brighten, retouch, improve complexion, enlarge eyes, change makeup, improve hair, improve lighting, or make the face more globally attractive. ' +
  'Collagen stimulation may make the skin read modestly firmer and healthier, with fine lines and folds somewhat softened, and no more than that. ' +
  'Do not improve, tighten, smooth, or reshape the neck or platysmal bands. ' +
  'Keep clearly visible in the result: pores, pigmentation, freckles, photodamage, under-eye shadows, skin redness, deep static wrinkles, perioral etching, neck texture and platysmal bands, crepey texture, facial asymmetry, original photo quality and lighting, hair messiness, and clothing. ' +
  'The more aged and sun-damaged the original face, the more of that aging must remain visible: a face with advanced baseline aging must retain its recognizable degree of aging and photodamage, shown with better support and healthier skin. The result must not read as materially younger or as though multiple years of aging have been removed. ' +
  'This result must look like the same imperfect consultation photo, not a clinic after photo. ' +
  'The only permitted changes are the soft-tissue structural support described above and the modest dermal-quality gain described here.';
